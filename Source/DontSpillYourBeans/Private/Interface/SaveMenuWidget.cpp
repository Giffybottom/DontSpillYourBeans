...
void  USaveMenuWidget::NativeConstruct()
{
	...
	if (newSM != nullptr)
	{
		...
		{
			newSaveMenu->buttonConfirm->buttonWTXT->OnClicked.AddDynamic(this, &USaveMenuWidget::MakeNewSave);
		}
		else
		{
...
void  USaveMenuWidget::MakeNewSave()
{
	if (nullptr != GamesInstance)
	{
